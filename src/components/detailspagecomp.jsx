    ...
    <div class="w-full lg:w-1/2 pl-4 lg:block border-[#610d83] h-auto">
        <div class="text-left mb-4">
            ...
            <ul class="list-disc list-inside text-white">
                <li>Ethical Conduct: Participants must adhere to ethical standards and conduct themselves in a responsible and lawful manner. Unethical behavior, including any attempt to compromise the integrity of the competition or violate legal boundaries, is strictly prohibited.</li>
                <li>Respect for Systems: Participants must respect the integrity of the systems and challenges provided for the event. Any malicious actions, such as attempting to disrupt services or intentionally damaging infrastructure, are not allowed.</li>
                {/* <!-- Add more rules as needed --> */}
            </ul>

            <ul class="list-disc list-inside text-white pt-8">
                <li><span class="text-gradient">Entry Fee:</span> 500/-</li>
                <li><span class="text-gradient">Mode of Participation :</span> Team</li>
                <li><span class="text-gradient">Prize Pool :</span> click on view more</li>
                {/* <!-- Add more rules as needed --> */}
            </ul>
        </div>
        ...
        <div class="flex justify-center space-x-4">
            <button class="bg-blue-500 text-white px-4 py-2 btn btn-sm">Register</button>
            <button class="bg-gray-500 text-white px-4 py-2 btn btn-sm">Learn More</button>
        </div>
    </div>
</div>
